public class test {
    public static String SQL = "CREATE TABLE `t_link_%d` (\n" +
            ...
            "  `domain` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '域名',\n" +
            ...
            "  `origin_url` varchar(1024) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '原始链接',\n" +
            "  `chick_num` int DEFAULT '0' COMMENT '点击量',\n" +
            "  `gid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '分组标识',\n" +
            "  `favicon` varchar(256) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '网站图标',\n" +
            ...
            "  `describe` varchar(1024) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '描述',\n" +
